...
<body>
  ...
  <div class="header_img">
    <div class="d-flex align-items-center justify-content-center" style="height:250px;"><h2 class="display-2 text-white"><strong>FAQ</strong></h2></div>
  </div>

  <!-- faq collapse -->

  <?php include("include/colapse.php"); ?>
