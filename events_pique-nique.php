    ...
    <div class="container-fluid my-5">
        <div class="row w-100 mb-5 mb-xl-0">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6"><img src="img/mascotte_montre.png" style="width:100%;"></div>
                <a href="event_register_piquenique.php"><button class="btn btn-secondary"><h2 class="policetitres" style="color: var(--color-yellow-middle); margin-bottom: 0!important;">S'inscrire</h2></button></a>
            </div>
            </div>
        </div>
    </div>
