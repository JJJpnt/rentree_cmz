...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center" style="height:250px;"><h2 class="display-2 text-white"><strong>Gacolor</strong></h2></div>
  </div>
    ...
    <div class="container-fluid">
        <div class="row w-100 text-center">
            ...
            <div
                ...
                <a href="event_register_gacolor.php" type="button" class="btn btn-light mx-auto my-auto">S'inscrire</a>
                <br>
            </div>
        </div>
    </div>
